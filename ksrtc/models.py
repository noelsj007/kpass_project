...
class PassForm(models.Model):
    ...
    idimage = models.ImageField(upload_to='users/static/ksrtcimage/idimage', null=True, default=None)
    adhaar_image = models.ImageField(upload_to='users/static/ksrtcimage/adhaar', null=True, default=None)
    profileimage = models.ImageField(upload_to='users/static/ksrtcimage/profileimage', null=True, default=None)